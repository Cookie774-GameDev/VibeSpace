...
export type AmbientTrackCategory = 'soundscape' | 'calm' | 'lofi' | 'rap';
...
export const AMBIENT_TRACKS: readonly AmbientTrackDef[] = [
  ...
  { id: 'soothing-rain', label: 'Soothing Rain', desc: 'Gentle rain with warm pads', category: 'calm', premium: false },
