-- Plugin connection metadata is synced through app_sync_records.
-- Secrets are intentionally excluded and remain in the device OS keychain.
-- This constraint prevents clients from using the generic document table to
-- upload credential-shaped fields for plugin connection records.
