...
The canonical remote is `Cookie774-GameDev/VibeSpace`.
...
- **Tauri names** like `VibeSpace_<version>_x64-setup.exe` are what the installers and updater resolve first.
- **Friendly names** like `VibeSpace-<version>-Windows-x64.exe` are for direct-download pages and humans.
